...
import { c as AstroError, Z as UnknownContentCollectionError, a4 as createComponent, S as RenderUndefinedEntryError, av as unescapeHTML, aq as renderTemplate, ar as renderUniqueStylesheet, an as renderScriptElement, a5 as createHeadAndContent, ah as renderComponent } from './astro/server_SUuzwIB7.mjs';
import 'piccolore';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_D4-gT334.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_CuX_eLNu.mjs').then(n => n._);
